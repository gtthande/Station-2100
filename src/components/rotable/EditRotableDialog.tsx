...
interface EditRotableDialogProps {
  partId: string;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export const EditRotableDialog = ({ partId, open, onOpenChange }: EditRotableDialogProps) => {
  const { rotableParts, updatePart, isUpdating } = useRotableParts();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-surface-dark border-white/10 text-white max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Edit Rotable Part</DialogTitle>
        </DialogHeader>
