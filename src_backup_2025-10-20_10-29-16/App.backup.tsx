          ...
          <ThemeProvider>
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/batch-submission" element={<ProtectedRoute><BatchSubmission /></ProtectedRoute>} />
                ...
                <Route path="/rotable-llp" element={<ProtectedRoute><RotableLLP /></ProtectedRoute>} />
                <Route path="/auth" element={<Auth />} />
                <Route path="/dev-sync" element={<ProtectedRoute><DevSyncPage /></ProtectedRoute>} />
                <Route path="/customers-suppliers" element={<ProtectedRoute><CustomersSuppliers /></ProtectedRoute>} />
