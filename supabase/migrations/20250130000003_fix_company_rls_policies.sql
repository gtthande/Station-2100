-- Fix company table RLS policies to allow authenticated users to manage company details
-- The current policies are too restrictive and only allow admin users
